...
***
<div><label><input type="checkbox"><div>체크</div></label><span>다음 약관에 모두 동의</span></div>
***
<div><label><input type="checkbox"><div>체크안됨</div></label><span>다음 약관에 모두 동의</span></div>
***
...
<div><label><input type="checkbox"><div><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"></path></svg></div></label><span>다음 약관에 모두 동의</span></div>
...
<div class="CheckBox_checkBox__1uvSa"><label><input type="checkbox"><div class="CheckBox_icon__2zG6x"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"></path></svg></div></label><span>다음 약관에 모두 동의</span></div>

***

<div class="CheckBox_checkBox__1uvSa"><label><input type="checkbox"><div class="CheckBox_icon__2zG6x"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="CheckBox_checked__2D8y_" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path></svg></div></label><span>다음 약관에 모두 동의</span></div>
